...
export default function PlacementCard() {
  ...
  return (
    <div className="tacoma-scroll absolute right-6 top-6 z-20 flex max-h-[calc(100vh-48px)] w-[330px] flex-col overflow-y-auto border border-tacoma-cream bg-zinc-950/[0.96] font-chakra">
      {/* Header */}
